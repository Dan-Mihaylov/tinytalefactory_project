...
class StoryGenerator:
        ...
        self.prompt = [
            {
                ...
                'content': 'Act as a custom children books writer, where you will receive prompts from people, telling'
                           ...
                           'memory of, and you will be writing a 10 SHORT paragraphs of a story which includes the'
                           'information you have been provided. The paragraphs MUST BE SEPARATED BY A NEW LINE.'
    ...
    def generate_prompt_from_questionary(self, name: str,  story_about: str, special_emphasis: str):
        resulting_prompt = (
