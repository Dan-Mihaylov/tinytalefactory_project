...
# print(user.tokens.promotional_tokens)
# print(user.tokens.purchased_tokens)
#
# user.tokens.promotional_tokens -= 1
# user.tokens.save()
# print(user.tokens.promotional_tokens)
# print('STORIES COUNT: ', user.stories.count())
...
print(os.getenv('DEBUG', '0') == '1')
print([host for host in os.getenv('ALLOWED_HOSTS', '').split(', ')])

print([cors for cors in os.getenv('CORS_ALLOWED_ORIGINS', '').split(', ')])