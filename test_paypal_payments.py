...
def create_order():
    ...
    data = '{ "intent": "CAPTURE", "purchase_units": [ { "reference_id": "d9f80740-38f0-11e8-b467-0ed5f89f718c", "amount": { "currency_code": "GBP", "value": "12.00" } } ], "payment_source": { "paypal": { "experience_context": { "payment_method_preference": "IMMEDIATE_PAYMENT_REQUIRED", "brand_name": "Tiny Tale Factory", "locale": "en-UK", "landing_page": "LOGIN", "user_action": "PAY_NOW", "return_url": "https://127.0.0.1:8000", "cancel_url": "https://127.0.0.1:8000/profile" } } } }'
